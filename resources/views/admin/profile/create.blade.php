  ...
  <div class="row">
    ...
    <div class="form-group row">
       <label class="col-md-2" for= "introduction">自己紹介欄</label>
        <div class ="col-md-10">
       <textarea class="form-control" rows="10" name="introduction"{{old('introduction')}}></textarea>
        </div>
    </div>
     <div class="form-group row">
       <label class="col-md-2" for= "personal_history">経歴</label>
        <div class ="col-md-10">
       <textarea class="form-control" rows="10" name="personal_history"{{old('personal_history')}}></textarea>
        </div>
    </div>
    {{csrf_field()}}
